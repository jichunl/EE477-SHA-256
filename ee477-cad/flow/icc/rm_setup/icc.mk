...
clock_opt_cts_icc: place_opt_icc
	...
	touch $(VPATH)/clock_opt_cts_icc

clock_opt_psyn_icc: clock_opt_cts_icc
	mkdir -p $(ICC_REPORTS_DIR) $(ICC_RESULTS_DIR) $(ICC_LOGS_DIR)
	$(ICC_EXEC) $(ICC_OPTIONS) -f rm_icc_scripts/clock_opt_psyn_icc.tcl |tee -i $(ICC_LOGS_DIR)/clock_opt_psyn_icc.log
	touch $(VPATH)/clock_opt_psyn_icc

clock_opt_route_icc: clock_opt_psyn_icc
	mkdir -p $(ICC_REPORTS_DIR) $(ICC_RESULTS_DIR) $(ICC_LOGS_DIR)
	$(ICC_EXEC) $(ICC_OPTIONS) -f rm_icc_scripts/clock_opt_route_icc.tcl |tee -i $(ICC_LOGS_DIR)/clock_opt_route_icc.log
	touch $(VPATH)/clock_opt_route_icc

route_icc: clock_opt_route_icc
	mkdir -p $(ICC_REPORTS_DIR) $(ICC_RESULTS_DIR) $(ICC_LOGS_DIR)
	$(ICC_EXEC) $(ICC_OPTIONS) -f rm_icc_scripts/route_icc.tcl |tee -i $(ICC_LOGS_DIR)/route_icc.log
	touch $(VPATH)/route_icc

route_opt_icc: route_icc
	mkdir -p $(ICC_REPORTS_DIR) $(ICC_RESULTS_DIR) $(ICC_LOGS_DIR)
	$(ICC_EXEC) $(ICC_OPTIONS) -f rm_icc_scripts/route_opt_icc.tcl |tee -i $(ICC_LOGS_DIR)/route_opt_icc.log
	touch $(VPATH)/route_opt_icc

chip_finish_icc: route_opt_icc
	mkdir -p $(ICC_REPORTS_DIR) $(ICC_RESULTS_DIR) $(ICC_LOGS_DIR)
	$(ICC_EXEC) $(ICC_OPTIONS) -f rm_icc_scripts/chip_finish_icc.tcl |tee -i $(ICC_LOGS_DIR)/chip_finish_icc.log
	touch $(VPATH)/chip_finish_icc

signoff_opt_icc: chip_finish_icc
	mkdir -p $(ICC_REPORTS_DIR) $(ICC_RESULTS_DIR) $(ICC_LOGS_DIR)
	$(ICC_EXEC) $(ICC_OPTIONS) -f rm_icc_scripts/signoff_opt_icc.tcl |tee -i $(ICC_LOGS_DIR)/signoff_opt_icc.log
	touch $(VPATH)/signoff_opt_icc

metal_fill_icc: signoff_opt_icc
	mkdir -p $(ICC_REPORTS_DIR) $(ICC_RESULTS_DIR) $(ICC_LOGS_DIR)
	$(ICC_EXEC) $(ICC_OPTIONS) -f rm_icc_scripts/metal_fill_icc.tcl |tee -i $(ICC_LOGS_DIR)/metal_fill_icc.log
	touch $(VPATH)/metal_fill_icc

signoff_drc_icc: metal_fill_icc
	mkdir -p $(ICC_REPORTS_DIR) $(ICC_RESULTS_DIR) $(ICC_LOGS_DIR)
	$(ICC_EXEC) $(ICC_OPTIONS) -f rm_icc_scripts/signoff_drc_icc.tcl |tee -i $(ICC_LOGS_DIR)/signoff_drc_icc.log
	touch $(VPATH)/signoff_drc_icc

outputs_icc: signoff_drc_icc
	mkdir -p $(ICC_REPORTS_DIR) $(ICC_RESULTS_DIR) $(ICC_LOGS_DIR)
	$(ICC_EXEC) $(ICC_OPTIONS) -f rm_icc_scripts/outputs_icc.tcl |tee -i $(ICC_LOGS_DIR)/outputs_icc.log
	touch $(VPATH)/outputs_icc
...
eco_icc:
	mkdir -p $(ICC_REPORTS_DIR) $(ICC_RESULTS_DIR) $(ICC_LOGS_DIR)
	$(ICC_EXEC) $(ICC_OPTIONS) -f rm_icc_scripts/eco_icc.tcl |tee -i $(ICC_LOGS_DIR)/eco_icc.log
	touch $(VPATH)/eco_icc
...
focal_opt_icc:
	mkdir -p $(ICC_REPORTS_DIR) $(ICC_RESULTS_DIR) $(ICC_LOGS_DIR)
	$(ICC_EXEC) $(ICC_OPTIONS) -f rm_icc_scripts/focal_opt_icc.tcl |tee -i $(ICC_LOGS_DIR)/focal_opt_icc.log
	touch $(VPATH)/focal_opt_icc

focal_opt: focal_opt_icc
	touch $(VPATH)/focal_opt
