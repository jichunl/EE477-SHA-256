...
source -echo $::env(BSG_DESIGNS_TARGET_DIR)/tcl/hard/$::env(BSG_DESIGNS_HARD_TARGET)/pin_placement.tcl
...
if {$::env(BSG_PACKAGING_FOUNDRY) == "portable"} {
  ...
  # STD: BETTER PNS
  source $::env(BSG_CHIP_DIR)/scripts/icc/dp_pns.tcl
}
