...
set DCRM_MW_LIBRARY_NAME                                ${DESIGN_NAME}_mwlib
...
set DCRM_FINAL_MAX_TIMING_REPORT                        ${DESIGN_NAME}.mapped.max.timing.rpt
set DCRM_FINAL_MIN_TIMING_REPORT                        ${DESIGN_NAME}.mapped.mix.timing.rpt
