...
set DC_REPORTS_DIR "[getenv DC_REPORTS_DIR]"
set DC_RESULTS_DIR "[getenv DC_RESULTS_DIR]"

if { ! [file exists $DC_REPORTS_DIR] } { file mkdir ${DC_REPORTS_DIR} }
if { ! [file exists $DC_RESULTS_DIR] } { file mkdir ${DC_RESULTS_DIR} }
...
if {$synopsys_program_name == "dc_shell"} {
  ...
  if {[shell_is_in_topographical_mode]} {
    ...
    check_library > ${DC_REPORTS_DIR}/${DCRM_CHECK_LIBRARY_REPORT}
