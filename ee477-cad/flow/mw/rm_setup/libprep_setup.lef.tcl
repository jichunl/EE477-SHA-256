...
# Setup file for library preparation based on LEF
...
# Suggest to specify the top cell name for hard macro
# ----------------------------------
set top_macro_name ""
...
# One single lef file containing the library cells:
# -------------------------------------------------
set lef_file ""

# Layer mapping file for reading LEF in:
# ---------------------------------
# Leave empty if none is to be used
set lef2MW_mapfile ""

# Antenna LEF file to load:
# -------------------------
# The antenna information is often embedded in the cell LEF file
# However, if there is a separate antenna LEF, you can enter it here.
# Leave empty if none is to be used or it is embedded in the cell LEF
set antenna_lef_file ""
...
# Derive cell boundary from specific shape for read_lef:
# -------------------------------------------------
# set to 1: by_overlap_layer (for rectilinear boundary)
# set to 0 : by_cell_size (default)
set boundary_by_overlap 1 
...
# Message prefixes:
# -----------------
set flow_info_prefix "LEF CELL PREP FLOW INFO >>"
set flow_warn_prefix "LEF CELL PREP FLOW WARNING >>"
set flow_err_prefix  "LEF CELL PREP FLOW ERROR >>"
