...
# If not set, the default sliver size is 0.
if {[info exists ICC_SLIVER_SIZE]} {
  set_fp_placement_strategy -sliver_size ${ICC_SLIVER_SIZE}
}
...
puts "running create_fp_placement"

# Add "-incremental" option so as not to touch hand-placed hard macros.
create_fp_placement -incremental all -effort low -no_legalize

puts "running legalize_fp_placement"

legalize_fp_placement

puts "running create_fp_placement"

create_fp_placement -incremental all -effort high
...
puts "RM-Info: Start analyzing power network\n"
...
puts "RM-Info: Completed analyzing power network\n"
