...
# For DDC
# read_ddc -r ${SOURCE_DIR}/${DESIGN_NAME}.mapped.ddc -libname ${FM_LIB_NAME}
if {$ICC_INIT_DESIGN_INPUT == "DDC" } {
  read_ddc -r $ICC_IN_DDC_FILE -libname ${FM_LIB_NAME}
}

# Or, for Verilog
# read_verilog -r ${SOURCE_DIR}/${DESIGN_NAME}.mapped.v -libname ${FM_LIB_NAME}
if {$ICC_INIT_DESIGN_INPUT == "VERILOG" } {
  read_verilog -r $ICC_IN_VERILOG_NETLIST_FILE -libname ${FM_LIB_NAME}
}
...
# read_milkyway -r -no_pg -libname ${FM_LIB_NAME} -cell_name ${DESIGN_NAME}_DCT ${MW_DESIGN_LIBRARY} -libname ${FM_LIB_NAME}

if { $ICC_INIT_DESIGN_INPUT == "MW" } {
  read_milkyway -r -no_pg -libname ${FM_LIB_NAME} -cell_name ${ICC_INPUT_CEL} ${MW_DESIGN_LIBRARY} -libname ${FM_LIB_NAME}
}
...
read_verilog -i $SOURCE_DIR/$DESIGN_NAME.$icc_output_cel.output.v -libname ${FM_LIB_NAME}
