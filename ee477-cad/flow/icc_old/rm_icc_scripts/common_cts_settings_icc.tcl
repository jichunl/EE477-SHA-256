...
if {$ICC_CTS_SHIELD_RULE_NAME != ""} {
  ...
  if {![regexp "Info: No nondrule" $x] && $ICC_CTS_SHIELD_CLK_NAMES != ""} {
    ...
    if {$ICC_CTS_SHIELD_RULE_NAME != $ICC_CTS_RULE_NAME} {
      puts "Warning: Overwriting $ICC_CTS_RULE_NAME by $ICC_CTS_SHIELD_RULE_NAME on $ICC_CTS_SHIELD_CLK_NAMES nets.\n"
    }
  } else {
    ...
    if {$ICC_CTS_SHIELD_RULE_NAME != $ICC_CTS_RULE_NAME} {
      puts "Warning: Overwriting $ICC_CTS_RULE_NAME by $ICC_CTS_SHIELD_RULE_NAME on all clock nets.\n"
    }
  }
