...
# MBT 5/10/2015: lock that sh*t down!
# MBT: causes crash
all_rp_groups

# MBT: running this causes Errors about fixed cells in rp groups
# to re-enable, we would have to temporarily unfix them
#check_rp_groups -all -verbose

set_rp_group_options bsg_chip::bdiom_in -cts_option fixed_placement
set_rp_group_options bsg_chip::cgno -cts_option fixed_placement
set_rp_group_options bsg_chip::cmno -cts_option fixed_placement
...
#
## When dealing with dirty designs, increasing the number violations per path to 20-30 when generating
## a snapshot can help find more issues after each run (create_qor_snapshot -max_paths 20).
#
