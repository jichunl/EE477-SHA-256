...
#  Note: if routing resource is a concern, consider to run these at chip_finish_icc step instead
  create_zrt_shield -nets [get_nets -hierarchical -all -filter "net_type == Clock"] \
                    -pg_via_tie_effort_level high \
                    -preferred_direction_only true \
                    -align_to_shape_end true
...
verify_zrt_route -antenna false > $REPORTS_DIR_CLOCK_OPT_ROUTE/$ICC_CLOCK_OPT_ROUTE_CEL.verify_zrt_route.rpt
