...
set_si_options -delta_delay true  \
               ...
               -static_noise_threshold_above_low $NOISE_MARGIN_ABOVE_LOW \
               -static_noise_threshold_below_high $NOISE_MARGIN_BELOW_HIGH \
...
set_route_opt_zrt_crosstalk_options -effort_level high                                ;# low|medium|high - default low
...
set_xtalk_route_options -track_assign_minimize_xtalk true \
  -groute_minimize_xtalk true

set_route_opt_strategy -xtalk_reduction_loops 3
