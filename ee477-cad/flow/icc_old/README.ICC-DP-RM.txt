...
*  For floorplan exploration, it can run automatically through the same flow 
   ...
   Results are presented in an HTML table.
...
*  Floorplanned CEL view and floorplan files that you can use to continue detailed 
   implementation with the IC Compiler Reference Methodology
 
*  Explore mode results summarized in an HTML file that you can view by using a 
   Web browser
