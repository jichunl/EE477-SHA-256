...
# Usage:
# ./lef_layer_tf_number_mapper.pl techfile.tf techlef.lef
...
if ($#ARGV < $EXPECTED_COMMAND_ARGS -1 ) {
  ...
  $lef_tf_map_file = "lef_to_mw_layer.map";
  $lef_tf_log_file = "lef_to_mw_layer.log";
}
